...
declare const useDropdownContext: (callerComponentName: string) => InternalDropdownContextValue;
...
declare function useDropdownItem({ index: indexProp, isLink, onClick, onDragStart, onMouseDown, onMouseEnter, onMouseLeave, onMouseMove, onMouseUp, onSelect, disabled, onFocus, valueText: valueTextProp, ref: forwardedRef, ...props }: DropdownItemProps & React.ComponentPropsWithoutRef<"div"> & {
    ...
    props: {
        ...
        onFocus: (event: React.FocusEvent<HTMLDivElement, Element>) => any;
...
declare function useDropdownPopover({ onBlur, portal, position, ref: forwardedRef, ...props }: DropdownPopoverProps & React.ComponentPropsWithoutRef<"div"> & {
    ...
    props: {
        ...
        onTransitionEndCapture?: React.TransitionEventHandler<HTMLDivElement> | undefined;
        ref: (node: any) => void;
        onBlur: (event: React.FocusEvent<HTMLDivElement, Element>) => any;
    };
};
...
export { DropdownItem, DropdownItemProps, DropdownItems, DropdownItemsProps, DropdownPopover, DropdownPopoverProps, DropdownProvider_ as DropdownProvider, DropdownProviderProps, DropdownTrigger, DropdownTriggerProps, useDropdownContext, useDropdownDescendants, useDropdownItem, useDropdownItems, useDropdownPopover, useDropdownTrigger };
